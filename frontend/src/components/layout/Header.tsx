      ...
      <div className="container mx-auto px-6 sm:px-12 max-w-7xl h-20 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-3.5">
          ...
          <button
            ...
            className="bg-[#1D5F49] hover:bg-[#174E3C] text-white px-6 py-2.5 rounded-xl text-[14px] font-semibold shadow-2xs hover:shadow-xs transition-all duration-150 active:scale-95"
          >
            Get Started
          </button>
        </div>
